...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        self.add_contact(wd, Contact(firstname="tuserfirst", middlename="tusermiddle", nickname="tusernick", lastname="tuserlast", title="contact", company="test", address="Moscow", homenumber="123",
